...
/* ==========================================================================
   ...
   Otto committenti, in scala di grigi, che scorrono di continuo appena
   ...
   PERCHE' SCORRE. Otto stemmi comunali fermi in fila sono otto rettangoli
   simili: corona muraria, scudo, corona d'alloro, e in mezzo un dettaglio
   di pochi pixel che li distingue. Fermi si leggono come uno ripetuto otto
   volte. In movimento passano uno per volta davanti all'occhio, e la
   ...
   su ventiquattro immagini e' lavoro che il telefono rifa a ogni fotogramma di
   una striscia che non si ferma mai; e sopra tutto, gli originali arrivano
   da otto fonti diverse con otto pesi diversi, e in fila si sarebbe visto
   ...
   di schermo i committenti sono otto, non ventiquattro.

   FERMA — con «riduci movimento», e senza JavaScript: le copie spariscono
   e gli otto marchi si dispongono su piu' righe, centrati. Non si
